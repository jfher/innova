...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { category: @contest.category, end_date: @contest.end_date, name: @contest.name, start_date: @contest.start_date }
    end
  ...
  test "should update contest" do
    patch :update, id: @contest, contest: { category: @contest.category, end_date: @contest.end_date, name: @contest.name, start_date: @contest.start_date }
    assert_redirected_to contest_path(assigns(:contest))
  end
